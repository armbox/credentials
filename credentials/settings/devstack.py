...
OAUTH2_PROVIDER_URL = 'https://smartlearn.io/oauth2'
...
SOCIAL_AUTH_EDX_OIDC_ISSUER = os.environ.get('SOCIAL_AUTH_EDX_OIDC_ISSUER', 'https://smartlearn.io/oauth2')
SOCIAL_AUTH_EDX_OIDC_URL_ROOT = os.environ.get('SOCIAL_AUTH_EDX_OIDC_URL_ROOT', 'https://smartlearn.io/oauth2')
SOCIAL_AUTH_EDX_OIDC_LOGOUT_URL = os.environ.get('SOCIAL_AUTH_EDX_OIDC_LOGOUT_URL', 'https://smartlearn.io/logout')
SOCIAL_AUTH_EDX_OIDC_PUBLIC_URL_ROOT = os.environ.get('SOCIAL_AUTH_EDX_OIDC_PUBLIC_URL_ROOT',
                                                      'https://smartlearn.io/oauth2')
...
JWT_AUTH['JWT_ISSUERS'].append({
    'AUDIENCE': 'lms-key',
    'ISSUER': 'https://smartlearn.io/oauth2',
